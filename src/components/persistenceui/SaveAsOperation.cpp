...
namespace
{
static LoggerFacade Log = LoggerFacade::createLogger("SaveAsOperation");
}
...
void SaveAsOperation::initialize(IServiceLocator *serviceLocator)
{
