...
CAROUSEL_BIN    = $${DEMOS_WD}/../$${BIN_OUTPUT_PATH}/bin
BIN_OUTPUT_PATH = $${DEMOS_WD}/$${BIN_OUTPUT_PATH}
...
#########################################################
# Change %CONFIG% placeholder in the DEMOS.sh startup script
