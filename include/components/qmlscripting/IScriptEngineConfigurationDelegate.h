...
/*!
 * @brief
 *   This interface used by the IScriptingService to configure QJSEngine
 ...
 * @sa IScriptExtension
 */
class QML_SCRIPTING_API IScriptEngineConfigurationDelegate : public QObject
{
    Q_OBJECT
public:
    /*!
...
public slots:
     ...
     */
    virtual void configureFromComponent(IComponent *component, QJSEngine *engine) = 0;
     ...
     */
    virtual void configureDefaults(QJSEngine *engine, IOutputHandler *output = nullptr) = 0;
