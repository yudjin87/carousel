 ...
 */
class QML_SCRIPTING_API ScriptUnit : public IScriptUnit
{
    Q_OBJECT
    typedef QScopedPointer<QJSEngine> QJSEnginePtr;

public:
    /*!
     * @details
     * @constructor{ScriptUnit} with empty script body and specified @a factory for QJSEngine
